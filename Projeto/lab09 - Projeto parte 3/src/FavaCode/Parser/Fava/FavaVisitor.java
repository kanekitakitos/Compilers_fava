...
public interface FavaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code FunctionDeclStat}
	 * labeled alternative in {@link FavaParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionDeclStat(FavaParser.FunctionDeclStatContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCallStat(FavaParser.FunctionCallStatContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FavaParser#exprList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprList(FavaParser.ExprListContext ctx);
	/**
	 * Visit a parse tree produced by {@link FavaParser#functionCall}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionCall(FavaParser.FunctionCallContext ctx);
	/**
	 * Visit a parse tree produced by {@link FavaParser#functionDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionDecl(FavaParser.FunctionDeclContext ctx);
	/**
	 * Visit a parse tree produced by {@link FavaParser#formalParameters}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFormalParameters(FavaParser.FormalParametersContext ctx);
	/**
	 * Visit a parse tree produced by {@link FavaParser#formalParameter}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFormalParameter(FavaParser.FormalParameterContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCallExpr(FavaParser.FunctionCallExprContext ctx);
	/**
